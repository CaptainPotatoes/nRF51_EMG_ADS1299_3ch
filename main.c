...
#define PERIPHERAL_LINK_COUNT            1                                          /**< Number of peripheral links used by the application. When changing this number remember to adjust the RAM settings*/
			/**@DEVICE INFO*/
#define DEVICE_NAME                      "EMG 250Hz"                      	    /**< Name of device. Will be included in the advertising data. */
#define DEVICE_NAME_500									 "EMG 500Hz" 
#define DEVICE_NAME_1000								 "EMG 1000Hz"
#define DEVICE_ERROR										 "EMG Other"
#define MANUFACTURER_NAME                "YEO-BNELab"                      				/**< Manufacturer. Will be passed to Device Information Service. */
#define DEVICE_MODEL_NUMBERSTR					 "Version 3.1"
#define DEVICE_FIRMWARE_STRING					 "Version 2.2"
...
static void application_timers_start(void)
{
    ...
    //uint32_t err_code;
    //err_code = app_timer_start(m_eeg_record_timer_id, TIMER_INTERVAL_UPDATE, NULL);
    //APP_ERROR_CHECK(err_code); 
}
